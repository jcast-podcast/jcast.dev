...
require_grep '/images/thumbnails/s01e01_[^"]+\.webp 320w' "public/episodes/s01e01-professional-developer-what/index.html"
require_grep '/images/blog/logo_[^"]+\.webp 320w' "public/blog/2026-05-08-genereren-van-afbeeldingen/index.html"
require_grep '/images/avatars/maarten-avatar_[^"]+\.webp 96w' "public/blog/2026-05-08-genereren-van-afbeeldingen/index.html"
require_grep '/images/logo-without-bg_[^"]+\.webp 80w' "public/index.html"
require_grep 'width="[0-9]+"' "public/about/index.html"
require_grep 'height="[0-9]+"' "public/about/index.html"
require_grep 'og:image" content="https://jcast.dev/images/thumbnails/s01e01.webp"' "public/episodes/s01e01-professional-developer-what/index.html"
